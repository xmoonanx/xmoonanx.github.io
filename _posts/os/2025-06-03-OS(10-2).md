---
title: "페이지 교체와 Page Replacement 알고리즘 - Operating System 10-2"
description: "Page replacement가 왜 필요한지, FIFO·OPT·LRU 같은 알고리즘이 어떤 기준으로 페이지를 교체하는지, 그리고 성능 평가를 어떻게 보는지 정리합니다."
...
🎯 **목표**: 한 프로세스가 너무 많은 frame을 소유하지 못하게 해서 **page fault를 예방**하기(**prevent over-allocation**)
