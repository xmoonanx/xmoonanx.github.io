---
title: "[🍃Spring] 데이터베이스 연동"

categories: [Framework, Spring]
tags:
  - [JAVA, Spring, 데이터베이스, JDBC, JPA, Repository, Service, DTO]
toc: true
toc_sticky: true
...
![JPA 동작 방식](../assets/img/Spring/image%201.png)
...
![DB 스키마](../assets/img/Spring/image%202.png)
...
![프록시 객체](../assets/img/Spring/image%203.png)
...
![계층형 아키텍처](../assets/img/Spring/image%204.png)
...
![DTO 개념](../assets/img/Spring/image%205.png)

![DTO 비유](../assets/img/Spring/image%206.png)
...
![스프링의 쓰레드 풀](../assets/img/Spring/image%207.png)
