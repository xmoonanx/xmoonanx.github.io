...
- **Recommended first post**: [Operating System(1-1): Interrupt, Oranizaion, Architecture]({% link _posts/os/2025-03-04-OS(1-1).md %})
...
1. [Operating System(1-1): Interrupt, Oranizaion, Architecture]({% link _posts/os/2025-03-04-OS(1-1).md %})
2. [Operating System(1-2): Operation, Resource Management, Virtualization]({% link _posts/os/2025-03-08-OS(1-2).md %})
3. [Operating System(2-1): Service, Interface, System calls, Link/Loaders]({% link _posts/os/2025-03-10-OS(2-1).md %})
4. [Operating System(2-2): Design, Implementation, Structure]({% link _posts/os/2025-03-11-OS(2-2).md %})
5. [Operating System(3-1): Process Scheduling/Creation/Termination, IPC]({% link _posts/os/2025-03-17-OS(3-1).md %})
6. [Operating System(3-2): Process]({% link _posts/os/2025-03-18-OS(3-2).md %})
...
9. [Operating System(5-1): CPU Scheduling]({% link _posts/os/2025-04-07-OS(5-1).md %})
10. [Operating System(5-2): Real-time Scheduling]({% link _posts/os/2025-04-14-OS(5-2).md %})
11. [Operating System(5-3): Scheduling: Linux,Window]({% link _posts/os/2025-04-14-OS(5-3).md %})
12. [Operating System(6-1): Critical section, peterson, Synchronization Hardware]({% link _posts/os/2025-04-28-OS(6-1).md %})
13. [Operating System(6-2): Mutax lock, Semaphore]({% link _posts/os/2025-04-29-OS(6-2).md %})
...
21. [Operating System(10-1): Virtual Memory, Demand Paging]({% link _posts/os/2025-06-02-OS(10-1).md %})
22. [Operating System(10-2): Page Replacement]({% link _posts/os/2025-06-03-OS(10-2).md %})
23. [Operating System(10-3): Allocation of Frame]({% link _posts/os/2025-06-10-OS(10-3).md %})
...
- **Intended reader level**: beginner to intermediate
- **Recommended first post**: [Chapter 1-1: MIPS]({% link _posts/ca/2025-03-11-CA(1-1).md %})
...
1. [Chapter 1-1: MIPS]({% link _posts/ca/2025-03-11-CA(1-1).md %})
2. [Chapter 1-2: MIPS(MAPS)]({% link _posts/ca/2025-03-18-CA(1-2).md %})
3. [Chapter 2-1: Memory Operands, R/I-type]({% link _posts/ca/2025-03-24-CA(2-1).md %})
4. [Chapter 2-2: MIPS Registers]({% link _posts/ca/2025-03-24-CA(2-2).md %})
...
10. [Chapter 5-2: Word addressing Exercies]({% link _posts/ca/2025-04-15-CA(5-2).md %})
...
20. [Chapter 11: Exploiting Memory Hierarchy(1) - Cache]({% link _posts/ca/2025-06-02-CA(11-1).md %})
...
- **Intended reader level**: beginner to intermediate
- **Recommended first post**: [Secure Coding(1-1) - SW개발보안 이해]({% link _posts/sc/2025-09-05-SC(1).md %})
...
1. [Secure Coding(1-1) - SW개발보안 이해]({% link _posts/sc/2025-09-05-SC(1).md %})
2. [Secure Coding(1-2) - SW개발보안 국내기준]({% link _posts/sc/2025-09-05-SC(1-2).md %})
3. [Secure Coding(1-3) - SW개발보안 국외기준]({% link _posts/sc/2025-09-05-SC(1-3).md %})
...
13. [Secure Coding(5-2) - OAuth2]({% link _posts/sc/2025-10-01-SC(5-2).md %})
...
16. [Secure Coding(6-2) - SQL Injection]({% link _posts/sc/2025-10-08-SC(6-2).md %})
...
- **Intended reader level**: beginner to intermediate
- **Recommended first post**: [Computer Networking(1): Intro]({% link _posts/cn/2025-03-10-CN(1).md %})
- **Related clusters**: [Operating system](#operating-system), [Secure coding and cybersecurity](#secure-coding-and-cybersecurity)

### Networking fundamentals

1. [Computer Networking(1): Intro]({% link _posts/cn/2025-03-10-CN(1).md %})
2. [Computer Networking: Application layer(1) - soket, HTTP, cache]({% link _posts/cn/2025-03-11-CN(2).md %})
3. [Computer Networking - Application layer(2): DNS, P2P]({% link _posts/cn/2025-03-17-CN(3).md %})
4. [Computer Networking - Transport layer(1): Multi/Demulti, UDP]({% link _posts/cn/2025-03-24-CN(4).md %})
5. [Computer Networking - Transport layer(2): rdt]({% link _posts/cn/2025-03-25-CN(5).md %})
